...
SFT_ADAPTER = "/root/workspace/train/saves/Qwen3-14B-Thinking/lora/sft_medical_2025-12-15-09-16-38"
...
WEIGHTS = [
    ("base", "base"), # Base Model (special handling)
    (0.0, 1.0),       # SFT Only
    (0.3, 0.7),       # Proposed
    (0.5, 0.5),
    (0.7, 0.3),
...
def merge_and_verify(pt_w, sft_w, gpu_id):
    ...
    try:
        ...
        # Rename directory to indicate failure? Or just log it.
        # shutil.move(merged_dir, merged_dir + "_FAILED")
